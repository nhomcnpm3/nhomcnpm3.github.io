                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="<?php echo $level.img_product_path."20.jpg"?>" alt="compare-product"></a>
                                        </div>
                                ...
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="<?php echo $level.img_product_path."21.jpg"?>" alt="compare-product"></a>
                                        </div>
                                        <span>mobile</span>
                                ...
                                <td class="product-description">
                                    <div class="compare-details">
                                        <div class="compare-detail-img">
                                            <a href="#"><img src="<?php echo $level.img_product_path."35.jpg"?>" alt="compare-product"></a>
                                        </div>
                                        <span>Games</span>
